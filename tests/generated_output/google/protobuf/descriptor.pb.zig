...
pub const FileDescriptorSet = struct {
    file: ?ArrayList(FileDescriptorProto) = null,
...
pub const FileDescriptorProto = struct {
    ...
    package: ?ArrayList(u8) = null,
    // Names of files imported by this file.
    dependency: ?ArrayList(ArrayList(u8)) = null,
    // Indexes of the public imported files in the dependency list above.
    public_dependency: ?ArrayList(i32) = null,
    // Indexes of the weak imported files in the dependency list.
    // For Google-internal migration only. Do not use.
    weak_dependency: ?ArrayList(i32) = null,
    // All top-level definitions in this file.
    message_type: ?ArrayList(DescriptorProto) = null,
    enum_type: ?ArrayList(EnumDescriptorProto) = null,
    service: ?ArrayList(ServiceDescriptorProto) = null,
    extension: ?ArrayList(FieldDescriptorProto) = null,
    ...
    syntax: ?ArrayList(u8) = null,
    // The edition of the proto file, which is an opaque string.
    edition: ?ArrayList(u8) = null,

    pub const _desc_table = .{
        .name = fd(1, .{ .List = .FixedInt }),
        .package = fd(2, .{ .List = .FixedInt }),
        .dependency = fd(3, .{ .List = .FixedInt }),
        .public_dependency = fd(10, .{ .List = .Simple }),
        .weak_dependency = fd(11, .{ .List = .Simple }),
        ...
        .syntax = fd(12, .{ .List = .FixedInt }),
        .edition = fd(13, .{ .List = .FixedInt }),
    };
...
pub const DescriptorProto = struct {
    name: ?ArrayList(u8) = null,
    field: ?ArrayList(FieldDescriptorProto) = null,
    extension: ?ArrayList(FieldDescriptorProto) = null,
    nested_type: ?ArrayList(DescriptorProto) = null,
    enum_type: ?ArrayList(EnumDescriptorProto) = null,
    extension_range: ?ArrayList(ExtensionRange) = null,
    oneof_decl: ?ArrayList(OneofDescriptorProto) = null,
    options: ?MessageOptions = null,
    reserved_range: ?ArrayList(ReservedRange) = null,
    // Reserved field names, which may not be used by fields in the same message.
    // A given name may only be reserved once.
    reserved_name: ?ArrayList(ArrayList(u8)) = null,
    ...
    pub const _desc_table = .{
        ...
        .reserved_name = fd(10, .{ .List = .FixedInt }),
    };
...
pub const ExtensionRangeOptions = struct {
    ...
    uninterpreted_option: ?ArrayList(UninterpretedOption) = null,
    // go/protobuf-stripping-extension-declarations
    // Like Metadata, but we use a repeated field to hold all extension
    // declarations. This should avoid the size increases of transforming a large
    // extension range into small ranges in generated binaries.
    declaration: ?ArrayList(Declaration) = null,
    ...
    pub const Declaration = struct {
        ...
        full_name: ?ArrayList(u8) = null,
        // The fully-qualified type name of the extension field. Unlike
        // Metadata.type, Declaration.type must have a leading dot for messages
        // and enums.
        type: ?ArrayList(u8) = null,
        ...
        pub const _desc_table = .{
            ...
            .full_name = fd(2, .{ .List = .FixedInt }),
            .type = fd(3, .{ .List = .FixedInt }),
...
pub const FieldDescriptorProto = struct {
    ...
    // namespace).
    type_name: ?ArrayList(u8) = null,
    // For extensions, this is the name of the type being extended.  It is
    // resolved in the same manner as type_name.
    extendee: ?ArrayList(u8) = null,
    // For numeric types, contains the original text representation of the value.
    // For booleans, "true" or "false".
    // For strings, contains the default text contents (not escaped in any way).
    // For bytes, contains the C escaped value.  All bytes >= 128 are escaped.
    default_value: ?ArrayList(u8) = null,
    ...
    pub const _desc_table = .{
        ...
        .type_name = fd(6, .{ .List = .FixedInt }),
        .extendee = fd(2, .{ .List = .FixedInt }),
        .default_value = fd(7, .{ .List = .FixedInt }),
        .oneof_index = fd(9, .{ .Varint = .Simple }),
        .json_name = fd(10, .{ .List = .FixedInt }),
        .options = fd(8, .{ .SubMessage = {} }),
...
pub const EnumDescriptorProto = struct {
    name: ?ArrayList(u8) = null,
    value: ?ArrayList(EnumValueDescriptorProto) = null,
    options: ?EnumOptions = null,
    // Range of reserved numeric values. Reserved numeric values may not be used
    // by enum values in the same enum declaration. Reserved ranges may not
    // overlap.
    reserved_range: ?ArrayList(EnumReservedRange) = null,
    ...
    pub const _desc_table = .{
        ...
        .reserved_name = fd(5, .{ .List = .FixedInt }),
    };
...
pub const ServiceDescriptorProto = struct {
    name: ?ArrayList(u8) = null,
    method: ?ArrayList(MethodDescriptorProto) = null,
...
pub const MethodDescriptorProto = struct {
    ...
    input_type: ?ArrayList(u8) = null,
    output_type: ?ArrayList(u8) = null,
    ...
    pub const _desc_table = .{
        .name = fd(1, .{ .List = .FixedInt }),
        .input_type = fd(2, .{ .List = .FixedInt }),
        .output_type = fd(3, .{ .List = .FixedInt }),
...
pub const FileOptions = struct {
    ...
    // domain names.
    java_package: ?ArrayList(u8) = null,
    // Controls the name of the wrapper Java class generated for the .proto file.
    // That class will always contain the .proto file's getDescriptor() method as
    // well as any top-level extensions defined in the .proto file.
    // If java_multiple_files is disabled, then all the other classes from the
    // .proto file will be nested inside the single wrapper outer class.
    java_outer_classname: ?ArrayList(u8) = null,
    ...
    objc_class_prefix: ?ArrayList(u8) = null,
    // Namespace for generated classes; defaults to the package.
    csharp_namespace: ?ArrayList(u8) = null,
    // By default Swift generators will take the proto package and CamelCase it
    // replacing '.' with underscore and use that to prefix the types/symbols
    // defined. When this options is provided, they will use this value instead
    // to prefix the types/symbols defined.
    swift_prefix: ?ArrayList(u8) = null,
    // Sets the php class prefix which is prepended to all php generated classes
    // from this .proto. Default is empty.
    php_class_prefix: ?ArrayList(u8) = null,
    // Use this option to change the namespace of php generated classes. Default
    // is empty. When this option is empty, the package name will be used for
    // determining the namespace.
    php_namespace: ?ArrayList(u8) = null,
    // Use this option to change the namespace of php generated metadata classes.
    // Default is empty. When this option is empty, the proto file name will be
    // used for determining the namespace.
    php_metadata_namespace: ?ArrayList(u8) = null,
    // Use this option to change the package of ruby generated classes. Default
    // is empty. When this option is not set, the package name will be used for
    // determining the ruby package.
    ruby_package: ?ArrayList(u8) = null,
    ...
    pub const _desc_table = .{
        .java_package = fd(1, .{ .List = .FixedInt }),
        .java_outer_classname = fd(8, .{ .List = .FixedInt }),
        ...
        .go_package = fd(11, .{ .List = .FixedInt }),
        ...
        .objc_class_prefix = fd(36, .{ .List = .FixedInt }),
        .csharp_namespace = fd(37, .{ .List = .FixedInt }),
        .swift_prefix = fd(39, .{ .List = .FixedInt }),
        .php_class_prefix = fd(40, .{ .List = .FixedInt }),
        .php_namespace = fd(41, .{ .List = .FixedInt }),
        .php_metadata_namespace = fd(44, .{ .List = .FixedInt }),
        .ruby_package = fd(45, .{ .List = .FixedInt }),
        .uninterpreted_option = fd(999, .{ .List = .SubMessage }),
    };
...
pub const FieldOptions = struct {
    ...
    targets: ?ArrayList(OptionTargetType) = null,
    // The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: ?ArrayList(UninterpretedOption) = null,
...
pub const UninterpretedOption = struct {
    name: ?ArrayList(NamePart) = null,
    // The value of the uninterpreted option, in whatever type the tokenizer
    // identified it as during parsing. Exactly one of these should be set.
    identifier_value: ?ArrayList(u8) = null,
    positive_int_value: ?u64 = null,
    negative_int_value: ?i64 = null,
    double_value: ?f64 = null,
    string_value: ?ArrayList(u8) = null,
    aggregate_value: ?ArrayList(u8) = null,
    ...
    pub const NamePart = struct {
        name_part: ?ArrayList(u8) = "",
        is_extension: bool = false,

        pub const _desc_table = .{
            .name_part = fd(1, .{ .List = .FixedInt }),
...
pub const SourceCodeInfo = struct {
    ...
    location: ?ArrayList(Location) = null,
    pub const Location = struct {
        ...
        leading_comments: ?ArrayList(u8) = null,
        trailing_comments: ?ArrayList(u8) = null,
        leading_detached_comments: ?ArrayList(ArrayList(u8)) = null,

        pub const _desc_table = .{
            .path = fd(1, .{ .List = .Simple }),
            .span = fd(2, .{ .List = .Simple }),
            .leading_comments = fd(3, .{ .List = .FixedInt }),
            .trailing_comments = fd(4, .{ .List = .FixedInt }),
            .leading_detached_comments = fd(6, .{ .List = .FixedInt }),
        };
...
pub const GeneratedCodeInfo = struct {
    ...
    annotation: ?ArrayList(Annotation) = null,
    pub const Annotation = struct {
        // Identifies the element in the original source .proto file. This field
        // is formatted the same as SourceCodeInfo.Location.path.
        path: ?ArrayList(i32) = null,
        // Identifies the filesystem path to the original source .proto.
        source_file: ?ArrayList(u8) = null,
        ...
        pub const _desc_table = .{
            .path = fd(1, .{ .List = .Simple }),
            .source_file = fd(2, .{ .List = .FixedInt }),
