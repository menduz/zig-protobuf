...
usingnamespace @import("../../protobuf/descriptor.pb.zig");
...
pub const CodeGeneratorRequest = struct {
    ...
    file_to_generate: ?ArrayList(ArrayList(u8)) = null,
    // The generator parameter passed on the command-line.
    parameter: ?ArrayList(u8) = null,
    ...
    // fully qualified.
    proto_file: ?ArrayList(FileDescriptorProto) = null,
    // The version number of protocol compiler.
    compiler_version: ?Version = null,

    pub const _desc_table = .{
        .file_to_generate = fd(1, .{ .List = .FixedInt }),
        .parameter = fd(2, .{ .List = .FixedInt }),
...
pub const CodeGeneratorResponse = struct {
    ...
    pub const File = struct {
        ...
        insertion_point: ?ArrayList(u8) = null,
        // The file contents.
        content: ?ArrayList(u8) = null,
        // Information describing the file content being inserted. If an insertion
        // point is used, this information will be appropriately offset and inserted
        // into the code generation metadata for the generated files.
        generated_code_info: ?GeneratedCodeInfo = null,

        pub const _desc_table = .{
            .name = fd(1, .{ .List = .FixedInt }),
            .insertion_point = fd(2, .{ .List = .FixedInt }),
            .content = fd(15, .{ .List = .FixedInt }),
